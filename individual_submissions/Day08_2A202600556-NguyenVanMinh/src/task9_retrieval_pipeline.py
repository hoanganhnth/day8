...
def retrieve(
    ...
    # Step 3: Rerank (chúng ta dùng RRF làm rerank chính nên bỏ qua step này)
    ...
    if not final_results or final_results[0]["score"] < score_threshold:
        ...
        print(f"  [Fallback] Hybrid score ({score_val:.3f}) < threshold ({score_threshold}). Fallback -> PageIndex")
